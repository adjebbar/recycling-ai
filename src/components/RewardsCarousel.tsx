          ...
          {rewards.map((reward) => {
            ...
            return (
              <CarouselItem key={reward.id} className="md:basis-1/2 lg:basis-1/3">
                <div className="p-1">
                  <Link to="/rewards">
                    <Card className="bg-card/70 backdrop-blur-lg border h-full flex flex-col items-center justify-center text-center p-6 hover:bg-accent/50 transition-colors">
